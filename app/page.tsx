...
export default function Home() {
  ...
  return (
    <main className="relative w-screen h-screen bg-[#080810] overflow-hidden">
      ...
      {/* Desktop: github + support buttons */}
      <div className="hidden md:flex absolute bottom-4 right-4 z-[1000] items-center gap-2">
        <a
          href="https://github.com/perturpe/Ufot"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 bg-[#0d0d1a]/90 border border-[#2a2a4a] hover:border-gray-500 text-gray-400 hover:text-gray-200 text-xs font-medium px-3 py-2 rounded-full transition-all shadow-lg"
        >
          <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.167 6.839 9.489.5.09.682-.217.682-.482 0-.237-.009-.868-.013-1.703-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.026A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.026 2.747-1.026.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.577.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>
          GitHub
        </a>
        <button
          onClick={() => setShowSupport(true)}
          className="flex items-center gap-1.5 bg-[#0d0d1a]/90 border border-purple-500/40 hover:border-purple-400 text-purple-300 hover:text-purple-200 text-xs font-medium px-3 py-2 rounded-full transition-all shadow-lg"
        >
          <span>♥</span> Support
        </button>
      </div>
      ...
      <div className="md:hidden absolute bottom-0 left-0 right-0 z-[1000]">
        ...
        <div className="relative flex bg-[#0d0d1a]/98 border-t border-[#2a2a4a]" style={{ height: 56 }}>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.167 6.839 9.489.5.09.682-.217.682-.482 0-.237-.009-.868-.013-1.703-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.463-1.11-1.463-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.832.092-.647.35-1.088.636-1.338-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.268 2.75 1.026A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.026 2.747-1.026.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.577.688.48C19.138 20.163 22 16.418 22 12c0-5.523-4.477-10-10-10z"/></svg>
